/* BINGO Extension Foundation — shared core utilities for Stage 4. */
(() => {
  const VERSION = '1.1.0';
  ...
  function mergeConfig(value = {}) { return {...defaults, ...(value || {})}; }
  ...
  async function setConfig(patch = {}) {
    ...
    if (typeof chrome !== 'undefined' && chrome.storage?.local) await chrome.storage.local.set({[KEY]: config});
    return config;
  }
  ...
  globalThis.BingoExtension = Object.freeze({
    ...
    log, safeClone, mergeConfig, getConfig, setConfig
  });
})();
